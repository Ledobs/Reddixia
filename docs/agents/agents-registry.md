...
- **Mission**: Agent orchestrateur qui utilise tous les autres agents et évalue l'état du portefeuille. Route les questions vers ATHENA-PORTF, ATLAS-CTRL, HERMES-PROJ, THEMIS-GOV, GAIA-RISK, VESTA-WORK, APOLLO-CHANGE.
- **Modèle**: GPT-5 Auto
...
## IA-TPG-006 - GAIA-RISK (Analyste et gardien registre des risques)
...
## IA-TPG-007 - VESTA-WORK (Gardienne données de référence)
...
## IA-TPG-009 - CERBERUS-SEC (Clôture & réconciliation)
...
## IA-TPG-010 - JANUS-CLOSE (Exceptions de facture)
...
## IA-TPG-011 - JANUS-CLOSE (Anomalies de dépenses)
...
## IA-TPG-013 - CERBERUS-SEC (Recouvrement / AR)
...
## IA-TPG-014 - ORPHEUS-ADOPT (Gouvernance data & veille)
...
## IA-TPG-017 - JUNO-PROC (Intelligence contractuelle)
...
## IA-TPG-019 - VULCAN-DEV (Procurement & RFP Ops)
...
| IA-TPG-006 | GAIA-RISK (Analyste et gardien registre des risques) | PortfolioOps | Portefeuille, Gouvernance | Non démarré | GPT-5 Auto |
| IA-TPG-007 | VESTA-WORK (Gardienne données de référence) | GovernanceOps | Gouvernance | Non démarré | GPT-5 Auto |
...
| IA-TPG-009 | CERBERUS-SEC (Clôture & réconciliation) | FinanceOps | Portefeuille, Gouvernance, Livrables | Approuvé (à implémenter) | GPT-5 Auto |
| IA-TPG-010 | JANUS-CLOSE (Exceptions de facture) | FinanceOps | Portefeuille, Gouvernance, Livrables | Approuvé (à implémenter) | GPT-5 Auto |
| IA-TPG-011 | JANUS-CLOSE (Anomalies de dépenses) | FinanceOps | Portefeuille, Gouvernance | Approuvé (à implémenter) | GPT-5 Auto |
| IA-TPG-012 | CASSANDRA-FQA (Finance Q&A) | FinanceOps | Conseils, Portefeuille, Gouvernance | Approuvé (à implémenter) | GPT-5 Auto |
| IA-TPG-013 | CERBERUS-SEC (Recouvrement / AR) | FinanceOps | Portefeuille, Conseils, Livrables | Approuvé (optionnel selon périmètre AR) | GPT-5 Auto |
| IA-TPG-014 | ORPHEUS-ADOPT (Gouvernance data & veille) | GovernanceOps | Gouvernance, Portefeuille | Approuvé (à implémenter) | GPT-5 Auto |
